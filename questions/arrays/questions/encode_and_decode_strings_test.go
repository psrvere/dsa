...
func (c *Codec) Decode_S3(strs string) []string {
	...
	for {
		...
		// strs = strs[:i] + strs[i+1:]
		// ne := strs[i+1 : i+2] // index out of bound error ?
		// i = i + 1
		// for {
		// 	if ne == ":" {
		// 		i = i + 1
...
// // create a local list of potential candidates for delimiter
// // type delimiter int
...
//     // we are choosing '-' as a delimiter to join words

//     // check if any of the words contain above delimiter
